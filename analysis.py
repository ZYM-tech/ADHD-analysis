...
#正确率为: 保持时间/有水流的总时间
#quantity为喝水时间,显示的正确率为保持时间
def feed_birds_water(data):
    start_ts = 0
    result = None
    quantity = 0
    for record in data:
...
#4洞权重0.2,5洞权重0.3,6洞权重0.5,求均值正确率
